...
def draw_info_text(image, brect, handedness, hand_sign_text, finger_gesture_text):
    cv.rectangle(image, (brect[0], brect[1]), (brect[2], brect[1] - 22), (255, 255, 255), -1)
    ...
    cv.rectangle(image, (brect[0], brect[1]), (brect[0] + text_size[0] + 10, brect[1] - 22), (255, 255, 255), -1)
    cv.putText(image, info_text, (brect[0] + 5, brect[1] - 4), cv.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 0), 1, cv.LINE_AA)
